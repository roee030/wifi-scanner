...
public class AndOperator implements Condition
{
	...
	public AndOperator(Condition filter1, Condition filter2)
	{
	 ...
	 * @return - the total file after first and second filter 
	 */
	public Total filter(Total total)
	{
		Total filter = new Total();
		AndOperator checker = new AndOperator(filter1, filter2);
	...
	public String toString()
	{
		...
		return "("+filter1.toString() + ") AND (" + filter2.toString() + ")";
	}
