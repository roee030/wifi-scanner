...
public class CreateCSV
{
	...
	public static String readfile(String fileName, boolean flag)
	{
		...
		{
			System.err.println("CreateCSV: readFile " + e.toString());
	...
	public static Total createTotal(String path)
	{
		...
		catch (FileNotFoundException e)
		{
			...
			e.printStackTrace();
			System.err.println("CreateCSV: " + e.toString());
		} 
	 ...
	 * @return create a new file with union all the .csv files.
	 */
	public static Total createTotalbyGivenTotal(String name, String text)
	{
		try
		{
	...
	/**
	 * This function added two totals into one
	 * @param source - the source
	 * @param added - the total you want to add to the source
	 */
	public static void addTotal(Total source, Total added)
	{
		for (int i = 0; i < added.getTotal().size(); i++)
		{
			source.add(added.getTotal().get(i));
		}
	}
	 ...
	 */
	public static Total unionAll(File[] list) throws Exception
	{
		String text = "";
		int i = 0;
		for (File file : list)
	 ...
	 * @param list - list of all the files
	 */
	public static Total unionAll(File[] list, Total total) throws Exception
	{
		String text = "";
		int i = 0;
		for (File file : list)
	 ...
	 * @param list - list of all the files
	 */
	public static Total unionAllCreateNewTotal(File[] list, Total total) throws Exception
	{
		...
		for (File file : list)
		{
			...
			for (String line : lines)
			{
				newTotal.insertLine(line, macs.get(i));
			}
			i++;
		}
		return newTotal;
